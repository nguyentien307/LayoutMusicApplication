 ...
 */
public class KoreanAlbumFragment extends Fragment {


    private String urlAlbum = "http://mp3.zing.vn/the-loai-album/Han-Quoc/IWZ9Z08W.html";

    private RecyclerView recyclerViewKoreanAlbum;
    private AlbumsAdapter adapter;
    private ArrayList<Album> albumList;

    public KoreanAlbumFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ((MainActivity)getActivity()).setActionBarTitle("Album Hàn Quốc");

        View v = inflater.inflate(R.layout.fragment_korean_album, container, false);
//        Toolbar toolbar = (Toolbar) v.findViewById(R.id.toolbar);
//        ((AppCompatActivity)getActivity()).setSupportActionBar(toolbar);
//
//        initCollapsingToolbar();

        recyclerViewKoreanAlbum = (RecyclerView) v.findViewById(R.id.recycler_view_korean_album);
...
//    }
    ...
    class ReadXML extends AsyncTask<String, Integer, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            recyclerViewKoreanAlbum.setLayoutManager(mLayoutManager);
            //recyclerViewViet.addItemDecoration(new GridSpacingItemDecoration(2, dpToPx(10), true));
            recyclerViewKoreanAlbum.setItemAnimator(new DefaultItemAnimator());
            adapter = new AlbumsAdapter(getContext(), albumList);
            adapter.notifyDataSetChanged();
            recyclerViewKoreanAlbum.setAdapter(adapter);
