 ...
 */
public class VietChartFragment extends Fragment {
    ...
    public ArrayList<String> listBXHVietCode = new ArrayList<>();
    public ArrayList<Song> listBXHViet = new ArrayList<Song>();
    public ArrayList<String> listBXHTitle = new ArrayList<String>();
    public ArrayList<String> listBXHArtist = new ArrayList<String>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v =  inflater.inflate(R.layout.fragment_viet_chart, container, false);
        imgViewNum1 = (ImageView) v.findViewById(R.id.id_homefrg_tablayout_num1_image);
        txtvSongNameNum1 = (TextView) v.findViewById(R.id.id_homefrg_tablayout_num1_songname);
        txtvArtistNum1 = (TextView) v.findViewById(R.id.id_homefrg_tablayout_num1_artist);
        recyclerView = (RecyclerView) v.findViewById(R.id.id_homefrg_tablayout_chartlist);
    ...
    class LoadDataCode extends AsyncTask<String, Integer, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            if(doc != null) {
                ...
                listBXHViet.add(new Song(title, artist, url, lyric, backimage, mv, link));


                tabLayoutChartAdapter = new TabLayoutChartAdapter(getActivity(),listBXHViet);
...
//                });
    ...
    class ReadXML extends AsyncTask<String, Integer, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            //XMLDOMParser1 parser = new XMLDOMParser1();
            org.jsoup.nodes.Document doc = Jsoup.parse(s);
            Elements list = doc.select("div.wrap-fullwidth-content .row");

            Element e = list.get(1);
            Element col = e.select(".col-4").get(0);
