 ...
 */
public class VietAlbumFragment extends Fragment {


    private String urlAlbum = "http://mp3.zing.vn/the-loai-album/Viet-Nam/IWZ9Z08I.html";

    private RecyclerView recyclerViewVietAlbum;
    private AlbumsAdapter adapter;
    private ArrayList<Album> albumList;

    public VietAlbumFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ((MainActivity)getActivity()).setActionBarTitle("Album Việt Nam");

        View v = inflater.inflate(R.layout.fragment_viet_album, container, false);
//        Toolbar toolbar = (Toolbar) v.findViewById(R.id.toolbar);
//        ((AppCompatActivity)getActivity()).setSupportActionBar(toolbar);
//
//        initCollapsingToolbar();

        recyclerViewVietAlbum = (RecyclerView) v.findViewById(R.id.recycler_view_viet_album);
...
//    }
    ...
    class ReadXML extends AsyncTask<String, Integer, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            recyclerViewVietAlbum.setLayoutManager(mLayoutManager);
            //recyclerViewViet.addItemDecoration(new GridSpacingItemDecoration(2, dpToPx(10), true));
            recyclerViewVietAlbum.setItemAnimator(new DefaultItemAnimator());
            adapter = new AlbumsAdapter(getContext(), albumList);
            adapter.notifyDataSetChanged();
            recyclerViewVietAlbum.setAdapter(adapter);
