 ...
 */
public class KoreanChartFragment extends Fragment {
    ...
    public ArrayList<String> listKoreanChartCode = new ArrayList<>();
    public ArrayList<Song> listKoreanChart = new ArrayList<Song>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v =  inflater.inflate(R.layout.fragment_korean_chart, container, false);
        imgViewNum1 = (ImageView) v.findViewById(R.id.id_homefrg_tablayout_num1_imagek);
        txtvSongNameNum1 = (TextView) v.findViewById(R.id.id_homefrg_tablayout_num1_songnamek);
        txtvArtistNum1 = (TextView) v.findViewById(R.id.id_homefrg_tablayout_num1_artistk);
        recyclerView = (RecyclerView) v.findViewById(R.id.id_homefrg_tablayout_chartlistk);
    ...
    class ReadXMLSong extends AsyncTask<String, Integer, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            listKoreanChartCode.add(data_code);
    ...
    class LoadDataCode extends AsyncTask<String, Integer, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            if(doc != null) {
                ...
                listKoreanChart.add(new Song(title, artist, url, lyric, backimage, mv, link));


                tabLayoutChartAdapter = new TabLayoutChartAdapter(getActivity(),listKoreanChart);
...
//                });
    ...
    class ReadXML extends AsyncTask<String, Integer, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            Element col = e.select(".col-4").get(2);
