 ...
 */
public class HoaTauAlbumFragment extends Fragment {


    private String urlAlbum = "http://mp3.zing.vn/the-loai-album/Hoa-Tau/IWZ9Z086.html";

    private RecyclerView recyclerViewHoaTauAlbum;
    private AlbumsAdapter adapter;
    private ArrayList<Album> albumList;

    public HoaTauAlbumFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ((MainActivity)getActivity()).setActionBarTitle("Album Hòa Tấu");

        View v = inflater.inflate(R.layout.fragment_hoa_tau_album, container, false);
//        Toolbar toolbar = (Toolbar) v.findViewById(R.id.toolbar);
//        ((AppCompatActivity)getActivity()).setSupportActionBar(toolbar);
//
//        initCollapsingToolbar();

        recyclerViewHoaTauAlbum = (RecyclerView) v.findViewById(R.id.recycler_view_hoa_tau_album);
...
//    }
    ...
    class ReadXML extends AsyncTask<String, Integer, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            recyclerViewHoaTauAlbum.setLayoutManager(mLayoutManager);
            //recyclerViewViet.addItemDecoration(new GridSpacingItemDecoration(2, dpToPx(10), true));
            recyclerViewHoaTauAlbum.setItemAnimator(new DefaultItemAnimator());
            adapter = new AlbumsAdapter(getContext(), albumList);
            adapter.notifyDataSetChanged();
            recyclerViewHoaTauAlbum.setAdapter(adapter);
